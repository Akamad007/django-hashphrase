...
class HashLink(models.Model):
    ...
    user = models.ForeignKey(User, related_name='hashlink_user')
    ...
    def verify_and_call_action_function(cls, request, raw_key, return_dict):
        ...
        hashlink_obj = return_dict.get('hashlink_obj',None)
        ...
        action_module, action_function = hashlink_functions.get_module_and_function('default_action') #global default
        if suggested_action in hashlink_functions.get_category_names():
            action_module, action_function = hashlink_functions.get_module_and_function(suggested_action)
        ...
        try:
            ...
            if settings.DEBUG:
                ...
                print ex
        try:
            return_obj = func(request, has_error, return_dict.get('error_code', ''), hashlink_obj, content_obj)
